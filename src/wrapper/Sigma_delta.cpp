...
Sigma_delta::Sigma_delta(const int i0, const int i1, const int j0, const int j1, sigma_delta_data_t* sd_data, const uint8_t N)
: spu::module::Stateful(), i0(i0), i1(i1), j0(j0), j1(j1), N(N), sd_data(sd_data)
{
    assert(sd_data != NULL);
